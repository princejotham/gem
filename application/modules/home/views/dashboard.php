...
if (!$this->ion_auth->in_group(array('superadmin'))) {
    $this->db->where('account__id', $this->account__id);
    ...
    if ($settings_lang == 'arabic') {
        ?>     
          ...
          $this->db->where('account__id', 'superadmin');
          $settings_lang = $this->db->get('settings')->row()->language;
          if ($settings_lang == 'arabic') {
              ?>
              dir="rtl"     
    ...
    <head>
        ...
        <meta name="keyword" content="Php, Account_, Clinic, Management, Software, Php, CodeIgniter, Hms, Accounting">
            ...
            <header class="header white-bg">
                ...
                <div class="nav notify-row" id="top_menu">
                    ...
                    <ul class="nav top-menu">
                        ...
                        <?php if ($this->ion_auth->in_group(array('admin', 'Case_manager', 'Health_worker'))) { ?> 
                        ...
                        <?php if ($this->ion_auth->in_group(array('admin', 'Finance_'))) { ?> 
                        ...
                        <?php if ($this->ion_auth->in_group(array('admin', 'Finance_', 'Case_manager', 'Health_worker', 'Laboratorist'))) { ?> 
                        ...
                        <!-- contact_list notification start-->
                        <?php if ($this->ion_auth->in_group(array('admin', 'Case_manager', 'Health_worker', 'Laboratorist', 'Patient'))) { ?> 
                            <?php if (in_array('contact_list', $this->modules)) { ?>
                                <li id="header_notification_bar" class="dropdown">
                                    <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                        <i class="fa fa-user"></i>
                                        <span class="badge bg-success">       
                                            ...
                                            $query = $query->result();
                                            foreach ($query as $contact_list) {
                                                $contact_list_number[] = '1';
                                            }
                                            if (!empty($contact_list_number)) {
                                                echo $contact_list_number = array_sum($contact_list_number);
                                            } else {
                                                $contact_list_number = 0;
                                                echo $contact_list_number;
                                            }
                                            ?>
                                        </span>
                                    </a>
                                    <ul class="dropdown-menu extended notification">
                                        ...
                                        <li>
                                            <p class="green"><?php
                                                echo $contact_list_number . ' ';
                                                if ($contact_list_number <= 1) {
                                                    echo lang('contact_list_registerred_today');
                                                } else {
                                                    echo lang('contact_lists_registerred_today');
                                                }
                                                ?> </p>
                                        </li>
                                        <li>
                                            <a href="contact_list"><p class="green"><?php echo lang('see_all_contact_lists'); ?></p></a>
                                        </li>
                                    </ul>
                                </li>
                            <?php } ?>
                        <?php } ?> 
                        <!-- contact_list notification end -->  
                        <!-- medicine notification start-->
                        <?php if ($this->ion_auth->in_group(array('admin', 'Pharmacist', 'Case_manager'))) { ?> 
                        ...
                        <?php if ($this->ion_auth->in_group(array('admin', 'Case_manager', 'Laboratorist', 'Health_worker'))) { ?> 
                            <?php if (in_array('report', $this->modules)) { ?>
                                <li id="header_notification_bar" class="dropdown">
                                    <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                        <i class="fa fa-account_-o"></i>
                                        <span class="badge bg-success">                         
                                            <?php
                                            $this->db->where('account__id', $this->account__id);
                                            $this->db->where('add_date', date('m/d/y'));
                    ...
                    <ul class="nav pull-right top-menu">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu extended logout">
                                ...
                                <li><a><i class="fa fa-user"></i> <?php echo $this->ion_auth->get_users_groupss()->row()->ffname ?></a></li>
                ...
                <div id="sidebar"  class="nav-collapse">
                    ...
                    <ul class="sidebar-menu" id="nav-accordion">
                        ...
                        <?php if ($this->ion_auth->in_group(array('admin'))) { ?>
                            <?php if (in_array('case_manager', $this->modules)) { ?>
                                <li> <li class="sub-menu">
                                    <a href="javascript:;" >
                                        <i class="fa fa-users"></i>
                                        <span>Case Mgmt Team</span>
                                    </a>
                                    <ul class="sub">
                                        <li><a href="case_manager"><i class="fa fa-user"></i><?php echo lang('list_of_case_managers'); ?></a></li>
                                        <li><a href="patient_care/treatmentReport"><i class="fa fa-money"></i><?php echo lang('treatment_history'); ?></a></li>
                                    </ul>
                                </li>
                            <?php } ?>
                        <?php } ?>
                        <?php if ($this->ion_auth->in_group(array('admin', 'Finance_', 'Health_worker', 'Case_manager', 'Laboratorist', 'Admin_comm'))) { ?>
                            <?php if (in_array('patient', $this->modules)) { ?>
                                <li> <li class="sub-menu">
                                    <a href="javascript:;" >
                                        <i class="fa fa-users"></i> 
                                    ...
                                    <ul class="sub"> 
                                        ...
                                        <?php if ($this->ion_auth->in_group(array('admin', 'Finance_', 'Case_manager', 'Admin_comm'))) { ?>
                                            <li><a href="patient/patientPayments"><i class="fa fa-dollar"></i><?php echo lang('payments'); ?></a></li>
                                        <?php } ?>
                                        <?php if (!$this->ion_auth->in_group(array('Finance_', 'Admin_comm'))) { ?>
                                            <li><a href="patient/caseList"><i class="fa fa-book"></i>Case History</a></li>
                                            <li><a href="patient/records"><i class="fa fa-file-text"></i><?php echo lang('records'); ?></a></li>
                                        <?php } ?>
                                    </ul>
                                </li>
                            <?php } ?>
                        ...
                        <?php if ($this->ion_auth->in_group(array('admin', 'Health_worker', 'Admin_comm'))) { ?>
                            <?php if (in_array('patient_care', $this->modules)) { ?>
                                <li> <li class="sub-menu">
                                    <a href="javascript:;" >
                        ...
                        <?php if ($this->ion_auth->in_group(array('admin', 'Case_manager', 'Health_worker', 'Admin_comm'))) { ?>
                            <?php if (in_array('patient_care', $this->modules)) { ?>
                                <li> <li class="sub-menu">
                                    <a href="javascript:;" >
                                        <i class="fa fa-stethoscope"></i> 
                                    ...
                                    <ul class="sub"> 
                                        <li><a href="patient_care"><i class="fa fa-list-alt"></i><?php echo lang('all'); ?></a></li>
                                        <li><a href="patient_care/addNewView"><i class="fa fa-plus-circle"></i><?php echo lang('add'); ?></a></li>
                                        <li><a href="patient_care/todays"><i class="fa fa-list-alt"></i><?php echo lang('todays'); ?></a></li>
                                        <li><a href="patient_care/upcoming"><i class="fa fa-list-alt"></i><?php echo lang('upcoming'); ?></a></li>
                                        <li><a href="patient_care/calendar"><i class="fa fa-list-alt"></i><?php echo lang('calendar'); ?></a></li>
                                        <li><a href="patient_care/request"><i class="fa fa-list-alt"></i><?php echo lang('request'); ?></a></li>
                        ...
                        <?php if ($this->ion_auth->in_group('admin')) { ?>
                            <li> <li class="sub-menu">
                                ...
                                <ul class="sub">
                                    <?php if (in_array('health_worker', $this->modules)) { ?>
                                        <li><a href="health_worker"><i class="fa fa-user"></i><?php echo lang('health_worker'); ?></a></li>
                                    <?php } ?>
                                    ...
                                    <?php } ?>
                                    <?php if (in_array('finance_', $this->modules)) { ?>
                                        <li><a href="finance_"><i class="fa fa-user"></i><?php echo lang('finance_'); ?></a></li>
                                    <?php } ?>
                                    <?php if (in_array('admin_comm', $this->modules)) { ?>
                                        <li><a href="admin_comm"><i class="fa fa-user"></i><?php echo lang('admin_comm'); ?></a></li>
                                    <?php } ?>
                                </ul>
                            </li>
                        <?php } ?>
                        ...
                        <?php if ($this->ion_auth->in_group('Admin_comm')) { ?>
                            <?php if (in_array('patient_care', $this->modules)) { ?>
                                <li>
                                    <a href="patient_care/calendar" >
                        ...
                        <?php
                        if ($this->ion_auth->in_group(array('Admin_comm'))) {
                            ?>
                        ...
                        <?php if ($this->ion_auth->in_group(array('Case_manager'))) { ?>
                            <?php if (in_array('prescription', $this->modules)) { ?>
                                <li>
                                    <a href="prescription">
                                        <i class="fa fa-dashboard"></i>
                        ...
                        <?php if ($this->ion_auth->in_group(array('admin', 'Case_manager', 'Laboratorist'))) { ?>
                            <?php if (in_array('lab', $this->modules)) { ?>
                                <li class="sub-menu">
                                    <a href="javascript:;" >
                        ...
                        <?php if ($this->ion_auth->in_group(array('admin', 'Laboratorist'))) { ?>
                            <?php if (in_array('contact_list', $this->modules)) { ?>
                                <li class="sub-menu">
                                    ...
                                    <ul class="sub">
                                        <li><a  href="contact_list"><i class="fa fa-user"></i>Contact List</a></li>
                                        <li><a  href="contact_list/addContact_listView"><i class="fa fa-plus-circle"></i><?php echo lang('add_contact_list'); ?></a></li>
                                        <li><a  href="contact_list/contactSummary"><i class="fa fa-tint"></i><?php echo lang('contact_summary'); ?></a></li>
                                    </ul>
                                </li>
                            <?php } ?>
                        <?php } ?>
                        ...
                        <?php if ($this->ion_auth->in_group(array('admin', 'Health_worker', 'Laboratorist', 'Case_manager'))) { ?>
                            <li class="sub-menu">
                                ...
                                <ul class="sub">
                                    ...
                                    <?php } ?>
                                    <?php if (in_array('report', $this->modules)) { ?>
                                        <li><a  href="report/birth"><i class="fa fa-smile-o"></i><?php echo lang('c19_report'); ?></a></li>
                                        <li><a  href="report/operation"><i class="fa fa-wheelchair"></i><?php echo lang('request_report'); ?></a></li>
                                       
                                    <?php } ?>
                                    <?php if ($this->ion_auth->in_group(array('admin'))) { ?>
                                        <?php if (in_array('finance', $this->modules)) { ?>
                                            <li><a  href="finance/case_managersCommission"><i class="fa fa-edit"></i><?php echo lang('case_managers_commission'); ?> </a></li>
                                        <?php } ?>
                                    <?php } ?>
                                </ul>
                            </li>
                        ...
                        <?php if ($this->ion_auth->in_group('Case_manager')) { ?>
                        ...
                        <?php if ($this->ion_auth->in_group('Finance_')) { ?>
                            <?php if (in_array('finance', $this->modules)) { ?>
                                <li class="sub-menu">
                                    <a href="javascript:;" >
                                        <i class="fa  fa-account_-o"></i>
                                ...
                                <li>
                                    <a href="finance/case_managersCommission" >
                                        <i class="fa fa-edit"></i>
                                        <span> <?php echo lang('case_managers_commission'); ?> </span>
                                    </a>
                                </li>
                                <li>
                        ...
                        <?php if ($this->ion_auth->in_group('Pharmacist')) { ?>
                            ...
                            <?php } ?>
                        <?php } ?>
                        <?php if ($this->ion_auth->in_group('Health_worker')) { ?>
                            <?php if (in_array('bed', $this->modules)) { ?>
                                <li>
                                    <a href="bed" >
                                        <i class="fa fa-hdd-o"></i>
                            ...
                            <?php if (in_array('contact_list', $this->modules)) { ?>
                                <li>
                                    <a href="contact_list" >
                                        <i class="fa fa-medkit"></i>
                                        <span> <?php echo lang('contact_list'); ?> </span>
                                    </a>
                                </li>
                                <li>
                                    <a href="contact_list/contactSummary" >
                                        <i class="fa fa-tint"></i>
                                        <span> <?php echo lang('contact_summary'); ?> </span>
                                    </a>
                                </li>
                            <?php } ?>
                        <?php } ?>
                            ...
                            <?php if (in_array('patient_care', $this->modules)) { ?>
                                <li>
                                    <a href="patient/calendar" >
                                        ...
                                        <span> <?php echo lang('patient_care'); ?> <?php echo lang('calendar'); ?> </span>
                                    </a>
                                </li>
                            <?php } ?>
                            <?php if (in_array('patient', $this->modules)) { ?>
                        ...
                        <?php if ($this->ion_auth->in_group('superadmin')) { ?>
                            ...
                            <li>
                                <a href="account_">
                                    <i class="fa fa-sitemap"></i>
                                    <span><?php echo lang('all_account_s'); ?></span>
                                </a>
                            </li>
                            <li>
                                <a href="account_/addNewView">
                                    <i class="fa fa-plus-circle"></i>
                                    <span><?php echo lang('create_new_account_'); ?></span>
                                </a>
                            </li>
                            ...
                            <li>
                                <a href="account_/package">
                                    <i class="fa fa-sitemap"></i>
                                    <span><?php echo lang('packages'); ?></span>
                                </a>
                            </li>
                            <li>
                                <a href="account_/package/addNewView">
                                    <i class="fa fa-plus-circle"></i>
