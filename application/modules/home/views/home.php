...
<section id="main-content">
    <section class="wrapper site-min-height">
        ...
        <?php if ($this->ion_auth->in_group(array('admin', 'Accoutant', 'Admin_comm'))) { ?> 
        ...
        <?php if ($this->ion_auth->in_group(array('admin', 'Case_manager', 'Health_worker', 'Admin_comm'))) { ?>
                                                                                                    <div class="col-lg-2 col-sm-12">
                                                                                                        <a href="patient_care/addNewView">
                                                                                                            <div class="panel-heading add_patient_care"> <?php echo lang('add_patient_care'); ?> </div>
                                                                                                        </a>
                                                                                                    </div>
        <?php } ?>
        ...
        <?php } ?>
        <?php if ($this->ion_auth->in_group(array('admin', 'Laboratorist', 'Case_manager'))) { ?>
                                                                                                    <div class="col-lg-2 col-sm-12">
        ...
        <?php if (!$this->ion_auth->in_group(array('Patient'))) { ?>
                                                                                                    <div class="col-lg-2 col-sm-12">
                                                                                                        <a href="patient/records">
                                                                                                            <div class="panel-heading add_patient"> <?php echo lang('add_records'); ?> </div> 
                                                                                                        </a>
                                                                                                    </div>
        <?php } ?>
        <?php if ($this->ion_auth->in_group(array('admin'))) { ?>
                                                                                                    <div class="col-lg-2 col-sm-12">
                                                                                                        <a href="settings">
                                                                                                            <div class="panel-heading add_patient_care"> <?php echo lang('change_settings'); ?> </div> 
                                                                                                        </a>
                                                                                                    </div>
        <?php } ?>
        <?php if ($this->ion_auth->in_group(array('admin'))) { ?>
            ...
            <?php if (in_array('patient_care', $this->modules)) { ?>
                <div class="state-overview col-md-5" style="padding: 23px 0px;">
                    <header class="panel-heading">
                        <i class="fa fa-user"></i>  <?php echo lang('todays_patient_cares'); ?>
                    </header>
                            ...
                            <table class="table table-striped table-hover table-bordered" id="editable-samplee">
                                ...
                                foreach ($patient_cares as $patient_care) {
                                    if ($patient_care->date == strtotime(date('Y-m-d'))) {
                                        ?>
                                        <tr class="">
                                            <td> <?php echo $this->db->get_where('patient', array('id' => $patient_care->patient))->row()->id; ?></td>
                                            <td> <?php echo $this->db->get_where('patient', array('id' => $patient_care->patient))->row()->name; ?></td>

                                            <td class="center"> <strong> <?php echo $patient_care->s_time; ?> </strong></td>
                                            <td>
                                                <?php echo $patient_care->status; ?>
                                            </td>
                                            <td>

                                                <a class="btn detailsbutton" title="<?php lang('history') ?>" style="color: #fff;" href="patient/medicalHistory?id=<?php echo $patient_care->patient ?>"><i class="fa fa-stethoscope"></i> <?php echo lang('history'); ?></a>
                                            </td>
                                        </tr>
                                        <?php
                                    }
        ...
        <!--
                        ...
                        <div class="col-lg-3 pull-right"> 
                            ...
                            <section class="">
                                <header class="panel-heading">
        <?php echo lang('account_'); ?> <?php echo lang('summary'); ?>
                                </header>
                                <div class="panel-body">
                
                                    <div class="home_section">
                                        <a href="case_manager">
        <?php echo lang('case_manager'); ?> :  <?php echo $this->db->count_all('case_manager'); ?> <hr>
                                        </a>
                                    </div>
        ...
        <?php echo lang('patient'); ?> :  <?php echo $this->db->count_all('patient'); ?> <hr>
                                    ...
                                    <div class="home_section">
        <?php echo lang('patient_care'); ?> :  <?php echo $this->db->count_all('patient_care'); ?> <hr>
                                    </div>
                                    <div class="home_section">
        ...
        <?php echo lang('lab_reports'); ?> :  <?php echo $this->db->count_all('lab'); ?> <hr>
                                    ...
                                    <div class="home_section">
        <?php echo lang('records'); ?> :  <?php echo $this->db->count_all('patient_material'); ?> <hr>
                                    </div>
                                    <div class="home_section">
        ...
        <?php if (!$this->ion_auth->in_group('superadmin')) { ?>
                                ...
                                <?php if ($this->ion_auth->in_group('admin')) { ?>
                                    ...
                                    <section class="panel home_sec_yellow">
                                        ...
                                        <div class="value">
                                            ...
                                            <p><?php echo lang('patient_care'); ?></p>
                                        </div>
                                    </section>
                                    <?php if ($this->ion_auth->in_group('admin')) { ?>
                                    </a>
                        ...
                        <div class="col-md-4">
                            <section class="panel">
                                ...
                                <div class="panel-body">
                                    ...
                                    <?php if (in_array('patient_care', $this->modules)) { ?>
                                        <div class="home_section">
                                            <?php echo lang('patient_care'); ?> : <?php echo $this_day['patient_care']; ?><hr>
                                        </div>
                                    <?php } ?>
                                </div>
                            </section>
                            ...
                            <section class="panel">
                                ...
                                <div class="panel-body">
                                    ...
                                    <?php if (in_array('patient_care', $this->modules)) { ?>
                                        <div class="home_section">
                                            <?php echo lang('patient_care'); ?> : <?php echo $this_month['patient_care']; ?> <hr>
                                        </div>
                                    <?php } ?>
                                </div>
                            </section>
                            ...
                            <section class="panel">
                                ...
                                <div class="panel-body">
                                    ...
                                    <?php if (in_array('patient_care', $this->modules)) { ?>
                                        <div class="home_section">
                                            <?php echo lang('patient_care'); ?> : <?php echo $this_year['patient_care']; ?> <hr>
                                        </div>
                                    <?php } ?>
            ...
            <section class="col-md-12">
                <div class="col-lg-6 col-sm-6 row">
                    <h1><span class="livee"><?php echo lang('live'); ?></span> hospital</h1>
                </div>
            </section>
            <?php foreach ($account_s as $account_) { ?>    
                <div class="col-lg-6 col-sm-6">
                    <section class="row panel col-md-12">
                        <div class="row symbol super col-md-6">
                            <?php echo $account_->name; ?>
                        </div>
                        <div class="value super1 col-md-6"> 
                            <p class="">
                                Email:   <?php echo $account_->email; ?>
                            </p>
                            <p class="">
                                Address:   <?php echo $account_->address; ?>
                            </p>
                            <p class="">
                                Phone:  <?php echo $account_->phone; ?>
                            </p>
                        </div>
                    </section>
                </div>
...
<script type="text/javascript">
    ...
    function drawChart() {
        ...
        var data = google.visualization.arrayToDataTable([
            ['Task', 'Hours per Day'],
            ['Treated', <?php
        if (!empty($this_month['patient_care_treated'])) {
            echo $this_month['patient_care_treated'];
        } else {
            echo '0';
        }
        ?>],
            ['cancelled', <?php
        if (!empty($this_month['patient_care_cancelled'])) {
            echo $this_month['patient_care_cancelled'];
        } else {
            echo '0';
        }
        ?>],
        ...
        var options = {
            title: selectedMonthName + ' Patient Care',
            pieHole: 0.4,
        };
