                                ...
                                <div class="adv-table editable-table ">
                                    ...
                                    <table class="table table-striped table-hover table-bordered" id="editable-sample">
                                        ...
                                        foreach ($meetings as $meeting) {
                                            if ($meeting->case_manager == $case_manager_id) {
                                                ?>
                                                <tr class="">
                                                    ...
                                                    <td>
                                                        ...
                                                        -->
                                                        <a class="btn btn-info btn-xs btn_width delete_button" href="meeting/delete?id=<?php echo $meeting->id; ?>&case_manager_id=<?php echo $meeting->case_manager; ?>" onclick="return confirm('Are you sure you want to delete this item?');"><i class="fa fa-trash"> </i></a>
                                                    </td>
                                                </tr>
                                                <?php
                                            }
            ...
            <section class="">
                <div class="panel-body profile">
                    <a href="#" class="task-thumb" style="margin-right: 10px;">
                        <img src="<?php
                        if (!empty($mmrcase_manager->img_url)) {
                            echo $mmrcase_manager->img_url;
                        } else {
            ...
            <div class="modal-body">
                <form role="form" id="editMeetingForm" action="meeting/addNew" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9"> 
                            <select class="form-control m-bot15"id="case_managerchoose1" name="case_manager" value=''>  
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        $('#calendarview').fullCalendar({
            lang: 'en',
            events: 'meeting/getMeetingByJasonByCase_manager?id=' +<?php echo $case_manager_id; ?>,
            header:
                    {
