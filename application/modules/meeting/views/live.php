...
<body>
    ...
    $case_manager = $meeting_details->case_managername;
    $patient = $meeting_details->patientname;
    
    $settings = $this->settings_model->getSettings();
    $account_ = $settings->system_vendor;
    ...
    <nav id="nav-tool" class="navbar navbar-inverse navbar-fixed-top">
        <div class="container">
            <div class="navbar-header">
                <h4><i class="fa fa-chromecast"></i> <?php echo $account_ ?> : <?php echo lang('live'); ?> <?php echo lang('patient_care'); ?> </h4>
            </div>
            <div class="navbar-form navbar-right">
                <?php if ($this->ion_auth->in_group('Patient')) { ?>
                    <h5><i class="far fa-user-circle" style=""></i> <?php echo lang('case_manager'); ?> : <?php echo $case_manager; ?></h5>
                <?php } ?>
    ...
    <script>
        ...
        var meetConfig = {
            ...
            leaveUrl: "<?php echo base_url(); ?>meeting",
            role: 1
        };
