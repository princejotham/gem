        ...
        <section class="panel">
            ...
            <div class="col-md-12">
                <div class="col-md-7 panel-body">
                    <section>
                        <form role="form" class="f_report" action="meeting/treatmentReport" method="post" enctype="multipart/form-data">
                            ...
                            <tr class="">
                                ...
                                <td>
                                    ...
                                    foreach ($meetings as $meeting) {
                                        if ($meeting->case_manager == $case_manager->id) {
                                    ...
                                    if (!empty($meeting_number)) {
                                        $meeting_total = array_sum($meeting_number);
                                        echo $meeting_total;
                                    } else {
                                        $meeting_total = 0;
                                        echo $meeting_total;
                                 ...
                                 <td> <a class="btn btn-info btn-xs btn_width add_payment_button" style="width: 100px;" href="meeting/getMeetingByCase_managerId?id=<?php echo $case_manager->id; ?>"><i class="fa fa-money"></i>  <?php  echo lang('details'); ?></a></td>
                               
                               
                            </tr>
                            <?php $meeting_number = NULL; ?>
                            <?php $meeting_total = NULL; ?>
                        <?php } ?>
