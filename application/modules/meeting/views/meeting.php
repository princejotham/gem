            ...
            <div class="modal-body row">
                <form role="form" action="meeting/addNew" method="post" class="clearfix" enctype="multipart/form-data">
                    ...
                    <div class="col-md-6 panel">
                        ...
                        <select class="form-control m-bot15" id="acase_managers" name="case_manager" value=''>  
        ...
        <div class="modal-content">
            ...
            <div class="modal-body row">
                <form role="form" id="editMeetingForm" action="meeting/addNew" class="clearfix" method="post" enctype="multipart/form-data">
                    ...
                    <div class="col-md-6 panel">
                        <label for="exampleInputEmail1">  <?php echo lang('case_manager'); ?></label> 
                        <select class="form-control m-bot15 case_manager" id="acase_managers1" name="case_manager" value=''>  
    ...
    $(document).ready(function () {
        $(".table").on("click", ".editbutton", function () {
            ...
            $.ajax({
                ...
                $('#editMeetingForm').find('[name="case_manager"]').val(response.meeting.case_manager).end()
                ...
                //$('.js-example-basic-single.case_manager').val(response.meeting.case_manager).trigger('change');
                ...
                var option1 = new Option(response.case_manager.name + '-' + response.case_manager.id, response.case_manager.id, true, true);
                $('#editMeetingForm').find('[name="case_manager"]').append(option1).trigger('change');
                ...
                $.ajax({
                    url: 'schedule/getAvailableSlotByCase_managerByDateByMeetingIdByJason?date=' + date + '&case_manager=' + case_managerr + '&meeting_id=' + meeting_id,
                    method: 'GET',
                    data: '',
                    dataType: 'json',
                }).success(function (response) {
...
<script type="text/javascript">
    $(document).ready(function () {
        $("#acase_managers1").change(function () {
            ...
            // $('#default').trigger("reset");
            $.ajax({
                url: 'schedule/getAvailableSlotByCase_managerByDateByMeetingIdByJason?date=' + date + '&case_manager=' + case_managerr + '&meeting_id=' + id,
                method: 'GET',
                data: '',
                dataType: 'json',
            }).success(function (response) {
    ...
    function dateChanged1() {
        ...
        // $('#default').trigger("reset");
        $.ajax({
            url: 'schedule/getAvailableSlotByCase_managerByDateByMeetingIdByJason?date=' + iid + '&case_manager=' + case_managerr + '&meeting_id=' + id,
            method: 'GET',
            data: '',
            dataType: 'json',
        }).success(function (response) {
...
<script>
    $(document).ready(function () {
        ...
        $("#acase_managers").select2({
            placeholder: '<?php echo lang('select_case_manager'); ?>',
            allowClear: true,
            ajax: {
                url: 'case_manager/getCase_managerInfo',
                type: "post",
                dataType: 'json',
                delay: 250,
                data: function (params) {
