            ...
            <section class="">
                <header class="panel-heading tab-bg-dark-navy-blueee">
                    <ul class="nav nav-tabs">
                        <li class="">
                            <a data-toggle="tab" href="#todays"><?php echo lang('todays'); ?> <?php echo lang('patient_cares'); ?></a>
                        </li>
                        <li class="">
                ...
                <div class="panel col-md-12">
                    <div class="tab-content">
                        <div id="todays" class="tab-pane">
                            <div class="">
                                <div class=" no-print">
                                    <a class="btn btn-info btn_width btn-xs" data-toggle="modal" href="#addPatient_careModal">
                                ...
                                <div class="adv-table editable-table ">
                                    <table class="table table-striped table-hover table-bordered" id="">
                                        ...
                                        <tbody>
                                            <?php
                                            foreach ($todays_patient_cares as $todays_patient_care) {
                                                $patient_details = $this->patient_model->getPatientById($todays_patient_care->patient);
                                                if (!empty($patient_details)) {
                                                    ?>
                                                    <tr class="">
                                                        <td><?php echo date('d-m-Y', $todays_patient_care->date); ?></td>
                                                        <td><?php echo $todays_patient_care->patient; ?></td>
                                                        <td><?php echo $patient_details->name; ?></td>
                                                        <td><?php echo $todays_patient_care->status; ?></td>
                                                        <td class="no-print">
                                                            <button type="button" class="btn btn-info btn-xs btn_width editPatient_careButton" title="<?php echo lang('edit'); ?>" data-toggle="modal" data-id="<?php echo $todays_patient_care->id; ?>"><i class="fa fa-edit"></i> </button>   
                                                            <a class="btn btn-info btn-xs btn_width delete_button" title="<?php echo lang('delete'); ?>" href="patient_care/delete?id=<?php echo $todays_patient_care->id; ?>" onclick="return confirm('Are you sure you want to delete this item?');"><i class="fa fa-trash-o"></i> </a>
                                                            <a class="btn btn-info btn-xs btn_width green" title="<?php echo lang('history'); ?>" style="color: #fff;" href="patient/medicalHistory?id=<?php echo $todays_patient_care->patient; ?>"><i class="fa fa-stethoscope"></i> <?php echo lang('patient'); ?> <?php echo lang('history'); ?></a>
                                                            <?php if ($todays_patient_care->status == 'Confirmed') { ?>
                                                                <a class="btn btn-info btn-xs btn_width detailsbutton" href="meeting/instantLive?id=<?php echo $todays_patient_care->id; ?>" <?php echo lang('live'); ?> target="_blank" onclick="return confirm('Are you sure you want to start a live meeting with this patient? SMS and Email will be sent to the Patient.');"><i class="fa fa-headphones"> <?php echo lang('live'); ?></i></a>
                                                            <?php } ?>
                                                        </td>
                                                    </tr>
                                                    <?php
                        ...
                        <div id="patient" class="tab-pane">
                            <div class="">
                                <div class="adv-table editable-table ">
                                    <?php if (!empty($patient_care_patients)) { ?>
                                        <table class="table table-striped table-hover table-bordered" id="editable-sample">
                                            ...
                                            <tbody>
                                                <?php
                                                foreach ($patient_care_patients as $patient_care_patient) {
                                                    $appointed_patient = $this->patient_model->getPatientById($patient_care_patient);
                                                    ?>
                                                    <tr class="">
                                        ...
                                        foreach ($holidays as $holiday) {
                                            ...
                                            <tr class="">
                                                ...
                                                <td>
                                                    ...
                                                    <a class="btn btn-info btn-xs btn_width delete_button" href="schedule/deleteHoliday?id=<?php echo $holiday->id; ?>&case_manager=<?php echo $case_manager->id; ?>&redirect=case_manager/details" onclick="return confirm('Are you sure you want to delete this item?');"><i class="fa fa-trash-o"> </i> <?php echo lang('delete'); ?></a>
                                                </td>
                                            </tr>
                                        <?php } ?>
                                        </tbody>
                ...
                <aside class="profile-nav">
                    <section class="">
                        <div class="user-heading round">
                            <a href="#">
                                <img src="<?php echo $case_manager->img_url; ?>" alt="">
                            </a>
                            <h1> <?php echo $case_manager->name; ?> </h1>
                            <p> <?php echo $case_manager->email; ?> </p>
                        </div>

                        <ul class="nav nav-pills nav-stacked">
                            <li class="active"> <?php echo lang('case_manager'); ?> <?php echo lang('name'); ?><span class="label pull-right r-activity"><?php echo $case_manager->name; ?></span></li>
                            <li>  <?php echo lang('case_manager_id'); ?> <span class="label pull-right r-activity"><?php echo $case_manager->id; ?></span></li>
                            <li>  <?php echo lang('profile'); ?><span class="label pull-right r-activity"><?php echo $case_manager->profile; ?></span></li>
                            <li>  <?php echo lang('address'); ?><span class="label pull-right r-activity"><?php echo $case_manager->address; ?></span></li>
                            <li>  <?php echo lang('phone'); ?><span class="label pull-right r-activity"><?php echo $case_manager->phone; ?></span></li>
                            <li>  <?php echo lang('email'); ?><span class="label pull-right r-activity"><?php echo $case_manager->email; ?></span></li>
                        </ul>
...
<div class="modal fade" id="addPatient_careModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
            ...
            <div class="modal-body">
                <form role="form" action="patient_care/addNew" class="clearfix row" method="post" enctype="multipart/form-data">
                    ...
                    <div class="col-md-4 panel">
                        ...
                        <select class="form-control js-example-basic-single" id="acase_managers" name="case_manager" value=''>  
                            <option value="">Select .....</option>
                    ...
                    <input type="hidden" name="redirect" value='case_manager/details'>
...
<!-- Edit Event Modal-->
<div class="modal fade" id="editPatient_careModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog modal-lg"">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            ...
            <div class="modal-body">
                <form role="form" id="editPatient_careForm" action="patient_care/addNew" class="clearfix row" method="post" enctype="multipart/form-data">
                    <div class="col-md-4 panel">
                        <label for="exampleInputEmail1"> <?php echo lang('patient'); ?></label>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form role="form" action="schedule/addHoliday" class="clearfix row" method="post" enctype="multipart/form-data">
                    ...
                    <input type="hidden" name="case_manager" value='<?php echo $case_manager->id; ?>'>
                    <input type="hidden" name="redirect" value='case_manager/details'>
                    <input type="hidden" name="id" value=''>
                    <div class="form-group col-md-12">
                        <button type="submit" name="submit" class="btn btn-info pull-right"> <?php echo lang('submit'); ?></button>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form role="form" action="schedule/addSchedule" class="clearfix row" method="post" enctype="multipart/form-data">
                    ...
                    <input type="hidden" name="case_manager" value='<?php echo $case_manager_id; ?>'>
                    <input type="hidden" name="redirect" value='case_manager/details'>
                    <input type="hidden" name="id" value=''>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form role="form" id="editTimeSlotForm" action="schedule/addSchedule" method="post" enctype="multipart/form-data">
                    ...
                    <input type="hidden" name="case_manager" value="<?php echo $case_managerr; ?>">
                    <input type="hidden" name="redirect" value='case_manager/details'>
                    <input type="hidden" name="id" value=''>
                    <button type="submit" name="submit" class="btn btn-info"> <?php echo lang('submit'); ?></button>
                </form>
    ...
    $(document).ready(function () {
        $(".editPrescription").click(function (e) {
            ...
            $.ajax({
                ...
                $('#prescriptionEditForm').find('[name="case_manager"]').val(response.prescription.case_manager).end()
...
<script type="text/javascript">
    $(document).ready(function () {
        $(".editPatient_careButton").click(function (e) {
            e.preventDefault(e);
            // Get the record's ID via attribute  
            var iid = $(this).attr('data-id');
            ...
            $('#editPatient_careModal').modal('show');
            $.ajax({
