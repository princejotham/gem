            ...
            <div class="panel-body">
                <div class="adv-table editable-table">
                    <div class="clearfix no-print">
                        <a data-toggle="modal" href="account_/package/addNewView">
                            <div class="btn-group">
                    ...
                    <table class="table table-striped table-hover table-bordered" id="editable-sample">
                        <thead>
                            <tr>
                                ...
                                <th> <?php echo lang('case_manager'); ?> <?php echo lang('limit'); ?></th>
                        ...
                        foreach ($packages as $package) {
                            ...
                            <tr class="">
                                ...
                                <td class="center" style="text-transform: capitalize;">
                                    <?php 
                                    $all_modules = array('finance_', 'patient_care', 'lab', 'bed', 'department', 'case_manager', 'contact_list', 'finance', 'pharmacy', 'laboratorist', 'medicine', 'health_worker', 'patient', 'pharmacist', 'prescription', 'admin_comm', 'report', 'sms', 'notice', 'email');
                                ...
                                <td class="no-print">
                                    <a type="button" class="btn btn-info btn-xs btn_width" data-toggle="" href="account_/package/editPackage?id=<?php echo $package->id; ?>" data-id="<?php echo $package->id; ?>"><i class="fa fa-edit"></i></a>   
                                    <a class="btn btn-info btn-xs btn_width delete_button" href="account_/package/delete?id=<?php echo $package->id; ?>" onclick="return confirm('Are you sure you want to delete this item?');"><i class="fa fa-trash-o"></i></a>
                                </td>
                            </tr>
                            <?php
                        }
