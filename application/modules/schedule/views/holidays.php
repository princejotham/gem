    ...
    <section class="wrapper site-min-height">
        ...
        <section class="panel">
            <header class="panel-heading">
                <?php echo lang('holiday'); ?> (<?php echo $this->db->get_where('case_manager', array('id' => $case_managerr))->row()->name; ?>)
                        ...
                        foreach ($holidays as $holiday) {
                            ...
                            <tr class="">
                                ...
                                <td>
                                    ...
                                    <a class="btn btn-info btn-xs btn_width delete_button" href="schedule/deleteHoliday?id=<?php echo $holiday->id; ?>&case_manager=<?php echo $case_managerr; ?>&redirect=schedule/holidays?case_manager=<?php echo $case_managerr; ?>" onclick="return confirm('Are you sure you want to delete this item?');"><i class="fa fa-trash-o"> </i> <?php echo lang('delete'); ?></a>
                                </td>
                            </tr>
                        <?php } ?>
                        </tbody>
