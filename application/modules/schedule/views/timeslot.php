    ...
    <section class="wrapper site-min-height">
        ...
        <section class="panel">
            <header class="panel-heading">
                 <?php echo lang('time_slots'); ?> (<?php echo $this->db->get_where('case_manager', array('id' => $case_managerr))->row()->name; ?>)
                            ...
                            if ($slot->weekday == 'Monday') {
                                ...
                                <tr class="">
                                    ...
                                    <td>
                                        ...
                                        <a class="btn btn-info btn-xs btn_width delete_button" href="schedule/deleteTimeSlot?id=<?php echo $slot->id; ?>&case_manager=<?php echo $case_managerr; ?>" onclick="return confirm('Are you sure you want to delete this item?');"><i class="fa fa-trash-o"> </i> <?php echo lang('delete'); ?></a>
                                    </td>
                                </tr>
                            <?php }
                        } ?>
