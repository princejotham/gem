    ...
    <section class="wrapper site-min-height">
        ...
        <section class="panel">
            <header class="panel-heading">
                <?php echo lang('time_schedule'); ?> (<?php echo $this->db->get_where('case_manager', array('id' => $case_managerr))->row()->name; ?>)
                            ...
                            foreach ($schedules as $schedule) {
                                ...
                                <tr class="">
                                    ...
                                    <td>
                                        ...
                                        -->
                                        <a class="btn btn-info btn-xs btn_width delete_button" href="schedule/deleteSchedule?id=<?php echo $schedule->id; ?>&case_manager=<?php echo $case_managerr; ?>&weekday=<?php echo $schedule->weekday; ?>" onclick="return confirm('Are you sure you want to delete this item?');"><i class="fa fa-trash-o"> </i> <?php echo lang('delete'); ?></a>
                                    </td>
                                </tr>
                            <?php } ?>
                        </tbody>
