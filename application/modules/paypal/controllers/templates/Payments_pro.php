...
class Payments_pro extends MX_Controller 
{
	...
	function Set_express_checkout()
	{
		$SECFields = array(
							...
							'maxamt' => '100', 						// The expected maximum total amount the order will be, including S&H and sales tax.
							'returnurl' => 'http://hms-new.rajbari-bazar.com', 							// Required.  URL to which the customer will be returned after returning from PayPal.  2048 char max.
							'cancelurl' => 'http://hms-new.rajbari-bazar.com', 							// Required.  URL to which the customer will be returned if they cancel payment on PayPal's site.
		...
		$Item = array(
					'name' => 'dgdfgd', 								// Item name. 127 char max.
					'desc' => 'dfgd', 								// Item description. 127 char max.
					'amt' => '10', 								// Cost of item.
					'number' => '42', 							// Item number.  127 char max.
					'qty' => '10', 								// Item qty on order.  Any positive integer.
	...
	{			
		$PayPalResult = $this->paypal_pro->GetExpressCheckoutDetails('EC-1TX840083W798345W');
	...
	{
            $DECPFields = array(
							'token' => 'EC-1TX840083W798345W', 								// Required.  A timestamped token, the value of which was returned by a previous SetExpressCheckout call.
							'payerid' => 'remonmahmud@yahoo.com', 							// Required.  Unique PayPal customer id of the payer.  Returned by GetExpressCheckoutDetails, or if you used SKIPDETAILS it's returned in the URL back to your RETURNURL.
		...
		$Payment = array(
						...
						'desc' => '', 							// Description of items on the order.  127 char max.
						'custom' => '', 						// Free-form field for your own use.  256 char max.
						'invnum' => '11', 						// Your own invoice or tracking number.  127 char max.
						'notifyurl' => '', 						// URL for receiving Instant Payment Notifications
						'shiptoname' => '', 					// Required if shipping is included.  Person's name associated with this address.  32 char max.
						'shiptostreet' => '', 					// Required if shipping is included.  First street address.  100 char max.
						'shiptostreet2' => '', 					// Second street address.  100 char max.
		...
		$PaymentOrderItems = array();
		$Item = array(
					'name' => 'account_ bill', 								// Item name. 127 char max.
					'desc' => 'jkkjkkj', 								// Item description. 127 char max.
					'amt' => '10', 								// Cost of item.
