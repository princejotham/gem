...
class Symptom extends MX_Controller {
    ...
    function __construct() {
        ...
        if (!$this->ion_auth->in_group(array('admin', 'Patient', 'Case_manager'))) {
    ...
    public function addNewSymptom() {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            if (!empty($for_case)) {
                ...
                redirect("patient/activity?case_manager_id=" . $case_manager_id);
            } elseif ($page == 'case_manager') {
                redirect("case_manager/activity?patient_id=" . $patient);
            }
        }
    }
