                    ...
                    <div class="invoice-list">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-md-4 pull-left" style="text-align: left;">
                                <div class="col-md-12 row details" style="">
                                    <p>
                                        <label class="control-label"><?php echo lang('case_manager'); ?> <?php echo lang('name'); ?> </label>
                                        <span style="text-transform: uppercase;"> : 
                                            <?php
                                            if (!empty($prescription->case_manager)) {
                                                $case_manager = $this->case_manager_model->getCase_managerById($prescription->case_manager);
