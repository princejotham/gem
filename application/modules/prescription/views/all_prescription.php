                    ...
                    <table class="table table-striped table-hover table-bordered" id="editable-sample">
                        ...
                        <?php foreach ($prescriptions as $prescription) { ?>
                            <tr class="">
                                ...
                                <td> 
                                    <?php
                                    $prescription_case_manager = $this->case_manager_model->getCase_managerById($prescription->case_manager);
                                    if (!empty($prescription_case_manager)) {
                                        echo $prescription_case_manager->name;
                                    }
                                    ?>
                                </td>
                                <td> 
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <select class="form-control m-bot15 js-example-basic-single case_manager" name="case_manager" value=''> 
                            ...
                            <?php foreach ($case_managers as $case_manager) { ?>
                                ...
                                if (!empty($prescription->case_manager)) {
                                    if ($prescription->case_manager == $case_manager->id) {
                                        echo 'selected';
                                    }
                                }
                                        ...
                                        $(document).ready(function () {
                                            $(".editPrescription").click(function (e) {
                                                ...
                                                $.ajax({
                                                    ...
                                                    $('.js-example-basic-single.case_manager').val(response.prescription.case_manager).trigger('change');
