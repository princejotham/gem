            ...
            <section class="panel">
                ...
                <div class="panel-body">  
                    ...
                    <form role="form" class="clearfix" action="sms/send" method="post">
                        ...
                        <div class="radio">
                            <label>
                                <input type="radio" name="radio" id="optionsRadios2" value="allcase_manager">
                                <?php echo lang('all_case_manager'); ?>
                            </label>
                        </div>
                        <div class="radio">
                            <label>
                                <input type="radio" name="radio" id="optionsRadios2" value="contactgroupwise">
                        ...
                        <div class="radio pos_client">
                            <label>
                                <?php echo lang('select_contact_group'); ?>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="" name="message" value="" cols="70" rows="10"></textarea>
                        </div>
...
<script>
    $(document).ready(function () {
        ...
        $('input[type=radio][name=radio]').change(function () {
            if (this.value == 'contactgroupwise') {
                $('.pos_client').show();
            } else {
                $('.pos_client').hide();
            }
