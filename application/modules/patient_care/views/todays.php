    ...
    <section class="wrapper site-min-height">
        ...
        <section class="panel">
            <header class="panel-heading">
                <?php echo lang('todays_patient_cares'); ?>
                            ...
                            if ($patient_care->date == strtotime(date('Y-m-d'))) {
                                ...
                                <tr class="">
                                    ...
                                    <td><?php
                                        ...
                                        ?></td>
                                    <td class="center"><?php echo date('d-m-Y', $patient_care->date); ?> <strong> <?php echo $patient_care->s_time; ?> - <?php echo $patient_care->e_time; ?> </strong></td>
                                    <td>
