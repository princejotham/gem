                            ...
                            <div class="panel-body">
                                <div class="adv-table editable-table ">
                                    ...
                                    <table class="table table-striped table-hover table-bordered" id="editable-sample">
                                        ...
                                        <?php foreach ($patient_care_pendings as $patient_care) { ?>
                                            <tr class="">
                                                <td ><?php echo $patient_care->id; ?></td>
                                                <td>
                                                    <?php
                                                    $patient = $this->patient_model->getPatientById($patient_care->patient);
                                                    if (!empty($patient)) {
                                                ...
                                                <td>
                                                    <?php
                                                    $case_manager = $this->case_manager_model->getCase_managerById($patient_care->case_manager);
                                                ...
                                                <td>
                                                    <button type="button" class="btn btn-info btn-xs btn_width editbutton" data-toggle="modal" data-id="<?php echo $patient_care->id; ?>"><i class="fa fa-edit"> </i> <?php echo lang('edit'); ?></button>   
                            ...
                            <div class="panel-body">
                                <div class="adv-table editable-table ">
                                    ...
                                    <table class="table table-striped table-hover table-bordered" id="editable-sample">
                                        ...
                                        <?php foreach ($patient_care_confirmeds as $patient_care) { ?>
                                            <tr class="">
                                                <td ><?php echo $patient_care->id; ?></td>
                                                <td>
                                                    <?php
                            ...
                            <div class="panel-body">
                                <div class="adv-table editable-table ">
                                    ...
                                    <table class="table table-striped table-hover table-bordered" id="editable-sample">
                                        ...
                                        <?php foreach ($patient_care_treateds as $patient_care) { ?>
                                            <tr class="">
                                                <td ><?php echo $patient_care->id; ?></td>
                                                <td>
                                                    <?php
                            ...
                            <div class="panel-body">
                                <div class="adv-table editable-table ">
                                    ...
                                    <table class="table table-striped table-hover table-bordered" id="editable-sample">
                                        ...
                                        <?php foreach ($patient_care_cancelleds as $patient_care) { ?>
                                            <tr class="">
                                                <td ><?php echo $patient_care->id; ?></td>
                                                <td>
                                                    <?php
                            ...
                            <div class="panel-body">
                                <div class="adv-table editable-table ">
                                    ...
                                    <table class="table table-striped table-hover table-bordered" id="editable-sample">
                                        ...
                                        <?php foreach ($patient_care_requesteds as $patient_care) { ?>
                                            <tr class="">
                                                <td ><?php echo $patient_care->id; ?></td>
                                                <td>
                                                    <?php
