                    ...
                    <div class="clearfix">
                        ...
                        <form role="form" id="editLabForm" class="clearfix" action="lab/addLab" method="post" enctype="multipart/form-data">
                            ...
                            <div class="">
                                ...
                                <div class="col-md-6 lab pad_bot">
                                    <label for="exampleInputEmail1"> <?php echo lang('refd_by_case_manager'); ?></label>
                                    <select class="form-control m-bot15 js-example-basic-single add_case_manager" id="add_case_manager" name="case_manager" value=''>  
                                        <option value="">Select .....</option>
                                        <option value="add_new" style="color: #41cac0 !important;"><?php echo lang('add_new'); ?></option>
                                        <?php foreach ($case_managers as $case_manager) { ?>
                                            <option value="<?php echo $case_manager->id; ?>"<?php
                                            if (!empty($lab->case_manager)) {
                                                if ($lab->case_manager == $case_manager->id) {
                                                    echo 'selected';
                                                }
                                            }
                                ...
                                <div class="pos_case_manager">
                                    <div class="col-md-8 lab pad_bot">
                                        <div class="col-md-3 lab_label"> 
                                            <label for="exampleInputEmail1"> <?php echo lang('case_manager'); ?> <?php echo lang('name'); ?></label>
                                        </div>
                                        <div class="col-md-9"> 
                                    ...
                                    <div class="col-md-8 lab pad_bot">
                                        <div class="col-md-3 lab_label"> 
                                            <label for="exampleInputEmail1"> <?php echo lang('case_manager'); ?> <?php echo lang('email'); ?></label>
                                        </div>
                                        <div class="col-md-9"> 
                                    ...
                                    <div class="col-md-8 lab pad_bot">
                                        <div class="col-md-3 lab_label"> 
                                            <label for="exampleInputEmail1"> <?php echo lang('case_manager'); ?> <?php echo lang('phone'); ?></label>
                                        </div>
                                        <div class="col-md-9"> 
                    ...
                    <div class="row invoice-list">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-md-6 pull-right" style="text-align: left;">
                                ...
                                <div class="col-md-12 row details">
                                    <p>
                                        <label class="control-label"><?php echo lang('case_manager'); ?>  </label>
                                        <span style="text-transform: uppercase;"> : 
                                            <?php
                                            if (!empty($lab->case_manager)) {
                                                echo $this->case_manager_model->getCase_managerById($lab->case_manager)->name . ' <br>';
                                            }
                                            ?>
                                        </span>
                                    </p>
...
<script>
    $(document).ready(function () {
        $('.pos_case_manager').hide();
        $(document.body).on('change', '#add_case_manager', function () {

            var v = $("select.add_case_manager option:selected").val()
            if (v == 'add_new') {
                $('.pos_case_manager').show();
            } else {
                $('.pos_case_manager').hide();
            }
        });
