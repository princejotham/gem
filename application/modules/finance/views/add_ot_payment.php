                                ...
                                <div class="panel-body">
                                    <form role="form" action="finance/addOtPayment" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-md-9"> 
                                                <select class="form-control m-bot15" name="case_manager_c_s" value=''>  
                                                    <option value="None">Select</option>
                                                    <?php foreach ($case_managers as $case_manager) { ?>
                                                        <option value="<?php echo $case_manager->id; ?>"<?php
                                                        if (!empty($ot_payment->case_manager_c_s)) {
                                                            if ($ot_payment->case_manager_c_s == $case_manager->id) {
                                                                echo 'selected';
                                                            }
                                                        }
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-md-9"> 
                                                <select class="form-control m-bot15" name="case_manager_a_s_1" value=''>  
                                                    <option value="None">Select</option>
                                                    <?php foreach ($case_managers as $case_manager) { ?>
                                                        <option value="<?php echo $case_manager->id; ?>"<?php
                                                        if (!empty($ot_payment->case_manager_a_s_1)) {
                                                            if ($ot_payment->case_manager_a_s_1 == $case_manager->id) {
                                                                echo 'selected';
                                                            }
                                                        }
                                                        ?>><?php echo $case_manager->name; ?> </option>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-md-9"> 
                                                <select class="form-control m-bot15" name="case_manager_a_s_2" value=''>  
                                                    <option value="None">Select</option>
                                                    <?php foreach ($case_managers as $case_manager) { ?>
                                                        <option value="<?php echo $case_manager->id; ?>"<?php
                                                        if (!empty($ot_payment->case_manager_a_s_2)) {
                                                            if ($ot_payment->case_manager_a_s_2 == $case_manager->id) {
                                                                echo 'selected';
                                                            }
                                                        }
                                                        ?>><?php echo $case_manager->name; ?> </option>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-md-9"> 
                                                <select class="form-control m-bot15" name="case_manager_anaes" value=''>  
                                                    <option value="None">Select</option>
                                                    <?php foreach ($case_managers as $case_manager) { ?>
                                                        <option value="<?php echo $case_manager->id; ?>"<?php
                                                        if (!empty($ot_payment->case_manager_anaes)) {
                                                            if ($ot_payment->case_manager_anaes == $case_manager->id) {
                                                                echo 'selected';
                                                            }
                                                        }
                                                        ?>><?php echo $case_manager->name; ?> </option>
