                    ...
                    <table class="table table-striped table-hover table-bordered" id="editable-sample">
                        <thead>
                            <tr>
                                ...
                                <th><?php echo lang('account__fees'); ?></th>
                                <th><?php echo lang('case_manager_fees'); ?></th>
                        ...
                        <?php foreach ($ot_payments as $ot_payment) { ?>
                            ...
                            <tr class="">
                                ...
                                <td><?php echo $settings->currency; ?> <?php echo $ot_payment->account__fees; ?></td>
                                <td><?php echo $settings->currency; ?> <?php echo $ot_payment->case_manager_fees; ?></td>
                                <td class="no-print"> 
