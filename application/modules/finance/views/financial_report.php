                ...
                <section class="panel">
                    ...
                    <table class="table table-striped table-advance table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><h5><?php echo lang('total'); ?> <?php echo lang('account__amount'); ?></h5></td>
                                <td></td>
                                <td>
                                    <?php echo $settings->currency; ?>
                                    <?php
                                    if (!empty($payments)) {
                                        foreach ($payments as $payment) {
                                            $account__amount[] = $payment->account__amount;
                                        }
                                        if ($paid_number > 0) {
                                            $account__amount = array_sum($account__amount);
                                            echo $account__amount;
                                        } else {
                                            echo '0';
                                        }
                                    } else {
                            ...
                            <tr>
                                <td><h5><?php echo lang('total'); ?> <?php echo lang('case_managers_amount'); ?></h5></td>
                                <td></td>
                                <td>
                                    <?php echo $settings->currency; ?>
                                    <?php
                                    if (!empty($payments)) {
                                        ...
                                        if ($paid_number > 0) {
                                            $gross_case_manager_amount = array_sum($case_manager_amount);
                                            echo $gross_case_manager_amount;
                                        } else {
                                            echo '0';
                                        }
                                    } else {
                    ...
                    <div class="weather-bg">
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-xs-4">
                                    <i class="fa fa-money"></i>
                                    <?php echo lang('gross_account__amount'); ?>
                                </div>
                                <div class="col-xs-8">
                                    <div class="degree">
                                        <?php echo $settings->currency; ?>
                    ...
                    <div class="weather-bg">
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-xs-4">
                                    <i class="fa fa-money"></i>
                                    <?php echo lang('gross_case_managers_commission'); ?>
                                </div>
                                <div class="col-xs-8">
                                    <div class="degree">
                                        <?php echo $settings->currency; ?>
                                        <?php
                                        if (empty($gross_case_manager_amount)) {
                                            $gross_case_manager_amount = 0;
                                        }
                                        if (empty($gross_case_manager_amount_ot)) {
                                            $gross_case_manager_amount_ot = 0;
                                        }
                                        echo $case_manager_gross = $gross_case_manager_amount + $gross_case_manager_amount_ot;
                                        ?>
