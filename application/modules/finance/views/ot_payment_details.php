                                ...
                                <div class="bio-row">
                                    <p><span>Consultant Surgeon </span>: <?php
                                        if (!empty($ot_payment->c_s_f)) {
                                            echo $this->db->get_where('case_manager', array('id' => $ot_payment->case_manager_c_s))->row()->name . '--> ' . $ot_payment->c_s_f . ' ' . $settings->currency;
                                        }
                                        ?></p>
                                </div>
                                <div class="bio-row">
                                    <p><span>Assistant Surgeon (1) </span>: <?php
                                        if (!empty($ot_payment->a_s_f_1)) {
                                            echo $this->db->get_where('case_manager', array('id' => $ot_payment->case_manager_a_s_1))->row()->name . '--> ' . $ot_payment->a_s_f_1 . ' ' . $settings->currency;
                                        }
                                        ?></p>
                                </div>
                                <div class="bio-row">
                                    <p><span>Assistant Surgeon (2)</span>: <?php
                                        if (!empty($ot_payment->a_s_f_2)) {
                                            echo $this->db->get_where('case_manager', array('id' => $ot_payment->case_manager_a_s_2))->row()->name . '--> ' . $ot_payment->a_s_f_2 . ' ' . $settings->currency;
                                        }
                                        ?></p>
                                </div>
                                <div class="bio-row">
                                    <p><span>Anaesthesist </span>: <?php
                                        if (!empty($ot_payment->anaes_f)) {
                                            echo $this->db->get_where('case_manager', array('id' => $ot_payment->case_manager_anaes))->row()->name . '--> ' . $ot_payment->anaes_f . ' ' . $settings->currency;
                                        }
                                        ?></p>
                                </div>
                                <div class="bio-row">
