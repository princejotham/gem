                    ...
                    <table class="table table-striped table-hover table-bordered" id="editable-sample">
                        <thead>
                            <tr>
                                ...
                                <th><?php echo lang('refd_by_case_manager'); ?></th>
                                <th><?php echo lang('date'); ?></th>
                                <th><?php echo lang('sub_total'); ?></t>
                                <th><?php echo lang('discount'); ?></th>
                                <th><?php echo lang('total'); ?></th>
                                <th><?php echo lang('account__amount'); ?></th>
                                <th><?php echo lang('case_manager_amount'); ?></th>
                            ...
                            <tr class="">
                                ...
                                <td><?php
                                    if (!empty($payment->case_manager)) {
                                        echo $this->db->get_where('case_manager', array('id' => $payment->case_manager))->row()->name;
                                    }
                                    ?></td>
                                ...
                                <td><?php echo $settings->currency; ?> <?php echo $payment->account__amount; ?></td>
                                <td><?php echo $settings->currency; ?> <?php echo $payment->case_manager_amount; ?></td>
                                <td class="no-print"> 
