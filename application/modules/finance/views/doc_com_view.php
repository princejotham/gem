    ...
    <section class="wrapper site-min-height">
        ...
        <section class="panel">
            <header class="panel-heading">
                  <?php echo lang('payments'); ?> || <?php echo lang('case_manager'); ?> : <?php echo $this->case_manager_model->getCase_managerById($case_manager)->name; ?>
            </header>
            <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <div class="input-group input-large" data-date="13/07/2013" data-date-format="mm/dd/yyyy">
                                        ...
                                        <input type="hidden" class="form-control dpd2" name="case_manager" value="<?php
                    ...
                    <table class="table table-striped table-hover table-bordered" id="editable-sample">
                        <thead>
                            <tr>
                                ...
                                <th><?php echo lang('case_managers_commission'); ?></th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            <tr class="">
                                ...
                                <td><?php echo $settings->currency; ?> <?php
                                    if (!empty($payment->case_manager)) {
                                        $doc_com[] = $payment->case_manager_amount;
                                        echo $payment->case_manager_amount;
                                    }
                                    ?></td>
                            </tr>
                        <?php } ?>
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-xs-4">
                                ...
                                <?php echo lang('total_case_managers_commission'); ?>
                            </div>
                            <div class="col-xs-8">
                                <div class="degree">
