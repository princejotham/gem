...
class Patient_1 extends MX_Controller {
    ...
    function __construct() {
        ...
        if (!$this->ion_auth->in_group(array('admin', 'Health_worker', 'Finance_', 'Case_manager', 'Laboratorist', 'im', 'Patient'))) {
    ...
    public function addNew() {
        ...
        $this->form_validation->set_rules('case_manager', 'Case_manager', 'trim|min_length[2]|max_length[100]|xss_clean');
