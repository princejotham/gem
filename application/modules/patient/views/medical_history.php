            ...
            <section class="panel-body">   
                <header class="panel-heading tab-bg-dark-navy-blueee">
                    <ul class="nav nav-tabs">
                        <li class="active">
                            <a data-toggle="tab" href="#patient_cares"><?php echo lang('patient_cares'); ?></a>
                        </li>
                        <li class="">
                        ...
                        <li class="">
                            <a data-toggle="tab" href="#profile"><?php echo lang('records'); ?></a>
                        </li>
                        <li class="">
                ...
                <div class="panel">
                    <div class="tab-content">
                        <div id="patient_cares" class="tab-pane active">
                            <div class="">
                                ...
                                <?php } else { ?>
                                    <div class=" no-print">
                                        <a class="btn btn-info btn_width btn-xs" data-toggle="modal" href="#addPatient_careModal">
                                            <i class="fa fa-plus-circle"> </i> <?php echo lang('request_a_patient_care'); ?> 
                                        </a>
                                    </div>
                                <?php } ?>
                                <div class="adv-table editable-table ">
                                    <table class="table table-striped table-hover table-bordered" id="">
                                        ...
                                        <tbody>
                                            <?php foreach ($patient_cares as $patient_care) { ?>
                                                <tr class="">

                                                    <td><?php echo date('d-m-Y', $patient_care->date); ?></td>
                                                    <td><?php echo $patient_care->time_slot; ?></td>
                                                    <td>
                                                        <?php
                                                        $case_manager_details = $this->case_manager_model->getCase_managerById($patient_care->case_manager);
                                                        if (!empty($case_manager_details)) {
                                                            $patient_care_case_manager = $case_manager_details->name;
                                                        } else {
                                                            $patient_care_case_manager = '';
                                                        }
                                                        echo $patient_care_case_manager;
                                                        ?>
                                                    </td>
                                                    <td><?php echo $patient_care->status; ?></td>
                                                    <?php if (!$this->ion_auth->in_group('Patient')) { ?>
                                                        <td class="no-print">
                                                            <button type="button" class="btn btn-info btn-xs btn_width editPatient_careButton" title="<?php echo lang('edit'); ?>" data-toggle="modal" data-id="<?php echo $patient_care->id; ?>"><i class="fa fa-edit"></i> </button>   
                                                            <a class="btn btn-info btn-xs btn_width delete_button" title="<?php echo lang('delete'); ?>" href="patient_care/delete?id=<?php echo $patient_care->id; ?>" onclick="return confirm('Are you sure you want to delete this item?');"><i class="fa fa-trash-o"></i> </a>
                                                        </td>
                                                    <?php } ?>
                                                </tr>
                                            <?php } ?>
                                            ...
                                            <?php foreach ($prescriptions as $prescription) { ?>
                                                <tr class="">
                                                    ...
                                                    <td>
                                                        ...
                                                        if (!empty($case_manager_details)) {
                                                            $prescription_case_manager = $case_manager_details->name;
                                                        } else {
                                                            $prescription_case_manager = '';
                                                        }
                                                        echo $prescription_case_manager;
                                                        ?>
...
<div class="modal fade" id="editPatient_careModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog modal-lg"">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form role="form" id="editPatient_careForm" class="clearfix row" action="patient_care/addNew" method="post" enctype="multipart/form-data">
                    <div class="col-md-4 panel"> 
                        <label for="exampleInputEmail1"> <?php echo lang('patient'); ?></label>
