                    ...
                    <table class="table table-striped table-hover table-bordered" id="editable-sample">
                        <thead>
                            <tr>
                                ...
                                <?php if ($this->ion_auth->in_group(array('admin', 'Finance_', 'Admin_comm'))) { ?>
                        ...
                        if ($this->ion_auth->in_group(array('Case_manager'))) {
                            ...
                            $case_manager_id = $this->case_manager_model->getCase_managerByIonUserId($case_manager_ion_id)->id;
                          //  echo $case_manager_id; die();
                        }
                        ?>
                        ...
                        foreach ($patients as $patient) {
                            $patient_case_managers = explode(',', $patient->case_manager);
                            if (in_array($case_manager_id, $patient_case_managers)) {
                                ?>
                                <tr class="">
                    ...
                    <div class="form-group">
                        <div class="col-md-12">     
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="col-md-9"> 
                                    <select class="form-control m-bot15 js-example-basic-multiple" multiple="" name="case_manager[]" value=''> 
                                        <option value=""> </option>
...
<?php } ?> 
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control m-bot15" name="contactgroup" value=''>
                            <?php foreach ($groups as $group) { ?>
                                <option value="<?php echo $group->group; ?>" <?php
                                if (!empty($patient->contactgroup)) {
                                    if ($group->group == $patient->contactgroup) {
                                        echo 'selected';
                                    }
                                }
                    ...
                    <div class="form-group">
                        <div class="col-md-12">     
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="col-md-9"> 
                                    <select class="form-control m-bot15 js-example-basic-multiple case_manager" multiple="" name="case_manager[]" value=''>  
                                        <option value=""> </option> 
                                        <?php foreach ($case_managers as $case_manager) { ?>
                                            <option value="<?php echo $case_manager->id; ?>"><?php echo $case_manager->name; ?> </option>
<?php } ?>
                                            ...
                                            $(document).ready(function () {
                                                $(".editbutton").click(function (e) {
                                                    ...
                                                    $.ajax({
                                                        ...
                                                        $('#editPatientForm').find('[name="contactgroup"]').val(response.patient.contactgroup).end()
                                                        $('#editPatientForm').find('[name="p_id"]').val(response.patient.patient_id).end()

                                                        $('.js-example-basic-multiple.case_manager').val(response.patient_care.case_manager).trigger('change');
                                                    });
                                                });
                                            });
</script>
