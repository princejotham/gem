                ...
                <aside class="profile-info col-lg-9">
                    <section class="panel">
                        <div class="bio-graph-heading">
                            <?php echo lang('case_manager'); ?> : <?php echo $this->case_manager_model->getCase_managerById($patient->case_manager)->name; ?>
                        </div>
                        <div class="bio-graph-info">
                            ...
                            <div class="row">
                                ...
                                <div class="bio-row">
                                    <p><span><?php echo lang('contact_group'); ?> </span>: <?php echo $patient->contactgroup; ?></p>
                                </div>
                                <div class="bio-row">
                                ...
                                <div class="bio-row">
                                    <p>
                                        <span><?php echo lang('case_manager'); ?> </span>:
                                        <?php
                                        echo $this->case_manager_model->getCase_managerById($patient->case_manager)->name;
                                        ?>
                                    </p>
                                </div>
                                <div class="bio-row">
