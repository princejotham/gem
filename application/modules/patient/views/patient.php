            ...
            <div class="modal-body row">
                <form role="form" action="patient/addNew" class="clearfix" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group col-md-6">    
                        ...
                        <select class="form-control js-example-basic-single"  name="case_manager" value=''> 
                            <option value=""> </option>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body row">
                <form role="form" id="editPatientForm" action="patient/addNew" class="clearfix" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group col-md-6">    
                        <label for="exampleInputEmail1"><?php echo lang('case_manager'); ?></label>
                        <select class="form-control js-example-basic-single case_manager"  name="case_manager" value=''> 
                            <option value=""> </option>
                            <?php foreach ($case_managers as $case_manager) { ?>                                        
                                <option value="<?php echo $case_manager->id; ?>"><?php echo $case_manager->name; ?> </option>
                            <?php } ?> 
        ...
        <div class="modal-content">
            ...
            <div class="modal-body row">
                <form role="form" id="editPatientForm" action="patient/addNew" class="clearfix" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group col-md-4">
                        <label for="exampleInputEmail1"><?php echo lang('contact_group'); ?></label>
                        <div class="contactgroupClass"></div>
                    </div>
                    ...
                    <div class="form-group col-md-4">    
                        <label for="exampleInputEmail1"><?php echo lang('case_manager'); ?></label>
                        <div class="case_managerClass"></div>
                    </div>
...
<script type="text/javascript">
    ...
    $(".table").on("click", ".editbutton", function () {
        ...
        $.ajax({
            ...
            $('.js-example-basic-single.case_manager').val(response.patient.case_manager).trigger('change');
...
<script type="text/javascript">
    ...
    $(".table").on("click", ".inffo", function () {
        ...
        $('.contactgroupClass').html("").end()
        $('.patientidClass').html("").end()
        $('.case_managerClass').html("").end()
        $('.ageClass').html("").end()
        $.ajax({
            ...
            $('.contactgroupClass').append(response.patient.contactgroup).end()
            $('.patientidClass').append(response.patient.patient_id).end()
            $('.case_managerClass').append(response.case_manager.name).end()
