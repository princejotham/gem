            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body col-md-5" style="font-size: 10px;">
                    <div class="row invoice-list">
                        ...
                        <br>
                        <?php if (!empty($payment->case_manager)) { ?>
                            <span><strong>Referred By Case_manager:</strong></span> <span><?php echo $this->db->get_where('case_manager', array('id' => $payment->case_manager))->row()->name ?></span>
                        <?php } ?>
                    </div>
