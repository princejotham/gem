...
class Email extends MX_Controller {
    ...
    function sendEmailDuringPatient_care($patient, $case_manager, $date, $s_time, $e_time) {
        $emailSettings = $this->email_model->getEmailSettings();
        $username = $emailSettings->username;
        $password = $emailSettings->password;
        $api_id = $emailSettings->api_id;
        ...
        $recipient_p = 'Patient Id: ' . $patient_detail->id . '<br> Patient Name: ' . $patient_detail->name . '<br> Patient Email: ' . $patient_detail->email;
        $recipient_d = 'Case_manager Id: ' . $case_manager_detail->id . '<br> Patient Name: ' . $case_manager_detail->name . '<br> Case_manager Email: ' . $case_manager_detail->email;


        $to = $patient_detail->email . ', ' . $case_manager_detail->email;
