                                        ...
                                        <div class="panel panel-default">
                                            ...
                                            <div id="collapseOne" class="panel-collapse collapse" aria-expanded="false" style="height: 0px;">
                                                <div class="panel-body">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <label for="exampleInputEmail1"><?php echo lang('account__email'); ?></label>
                                        ...
                                        <div class="panel panel-default">
                                            ...
                                            <div id="collapseTwo" class="panel-collapse collapse" aria-expanded="false" style="height: 0px;">
                                                <div class="panel-body">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <label for="exampleInputEmail1"><?php echo lang('case_manager_block__text_under_title'); ?></label>
                                                        <input type="text" class="form-control" name="case_manager_block__text_under_title" id="exampleInputEmail1" value='<?php
                                                        if (!empty($settings->case_manager_block__text_under_title)) {
                                                            echo $settings->case_manager_block__text_under_title;
                                                        }
                                                        ?>' placeholder="">
                                                    </div>
                                                </div>
