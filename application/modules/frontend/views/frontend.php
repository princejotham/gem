            ...
            <nav class="navbar navbar-expand-lg py-3 fixed-top scrollTop bg-light">
                <div class="container">
                    <a class="navbar-brand" href="frontend#header">
                        <?php echo $title[0]; ?><span><?php echo $title[1]; ?> </span>
                    </a>
                    ...
                    <div class="collapse navbar-collapse" id="bar">
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item"><a class="nav-link" href="frontend#account_-management">Book Patient Care</a></li>
                            <li class="nav-item"><a class="nav-link" href="frontend#service">Service</a></li>
                            <li class="nav-item"><a class="nav-link" href="frontend#package">Featured Case Manager</a></li>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <form action="frontend/addNew" method="post">
                                                    ...
                                                    <label>Barangay:</label>
                                                     <select class="form-control" name="account_" id="aaccount_s">
                                                        ...
                                                        <?php foreach ($account_s as $account_) { ?>
                                                            <option value="<?php echo $account_->id; ?>"<?php
                                                            if (!empty($payment->account_)) {
                                                                if ($payment->account_ == $account_->id) {
                                                                    echo 'selected';
                                                                }
                                                            }
                                                            ?>><?php echo $account_->name; ?> </option>
                                                                <?php } ?>
                                                    ...
                                                    <label for=""> <?php echo lang('case_manager'); ?></label>
                            ...
                            <?php foreach ($services as $service) { ?>
                                <div class="col-md-6 justify-content-between">
                                    <div class="service-content-left">
                                      <!--  <img src=" <?php echo $service->img_url; ?>" alt=""> -->
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12 text-center py-5">
                                ...
                                <p><?php echo $settings->case_manager_block__text_under_title; ?></p>
                            </div>
                        </div>
                        <div class="row">
            ...
            <script type="text/javascript">
                $(document).ready(function () {
                    $("#acase_managers").change(function () {
                        ...
                        $.ajax({
                            url: 'frontend/getAvailableSlotByCase_managerByDateByJason?date=' + date + '&case_manager=' + case_managerr,
                            method: 'GET',
                            data: '',
                            dataType: 'json',
            ...
            <script type="text/javascript">
                $(document).ready(function () {
                    $("#aaccount_s").change(function () {
                        var id=$(this).val();
                        $.ajax({
                            url:"<?php echo site_url('frontend/get_case_managers_account_'); ?>",
                            method:"POST",
                            data:{id:id},
                            async:true,
                            dataType:'JSON',
