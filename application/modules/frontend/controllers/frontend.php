...
class Frontend extends MX_Controller {
    ...
    public function index() {
        ...
        $data['account_s'] = $this->case_manager_model->getHos();
    ...
    public function get_case_managers_account_() {
        $account__id = $this->input->post('id', TRUE);
        $data = $this->frontend_model->getCase_managerByAccount_($account__id);
        echo json_encode($data);
    }

     public function addNew() {

        $account_ = $this->input->post('account_');
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            if ($patient == 'add_new') {
                ...
                if ($this->ion_auth->email_check($p_email)) {
                    ...
                    $this->patient_model->insertPatientt($data_p);
            ...
            if (empty($id)) {     // Adding New department
                $this->frontend_model->insertPatient_care($data);
                ...
                $this->session->set_flashdata('feedback', lang('patient_care_added_successfully_please_wait_you_will_get_a_confirmation_sms'));
            }
    ...
    public function update() {
        ...
        $case_manager_block_text_under_title = $this->input->post('case_manager_block__text_under_title');
        ...
        if (!empty($email)) {
            ...
            // Validating Currency Field   
            $this->form_validation->set_rules('case_manager_block__text_under_title', 'Case_manager Block Text Under Title', 'trim|min_length[1]|max_length[500]|xss_clean');
            // Validating Currency Field   
            ...
            if ($this->form_validation->run() == FALSE) {
                ...
                if ($this->upload->do_upload('img_url')) {
                    ...
                    $data = array(
                        ...
                        'case_manager_block__text_under_title' => $case_manager_block_text_under_title,
    ...
    function getAvailableSlotByCase_managerByDateByJason() {
        ...
        $data['aslots'] = $this->frontend_model->getAvailableSlotByCase_managerByDate($date, $case_manager);
        echo json_encode($data);
    }
